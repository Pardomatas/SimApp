//checksim.java
//demonstrates queue used in simulation of supermarket lines
import java.io.*;
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
class Queue
{
...
class Checker
{
	...
	private int myTimer;
//------------------------------------------------------------------------------------------------------------------
	public Checker(int chn, int max1) //constructor
	{
		myNumber = chn + 1;
		myQueue = new Queue(max1);
...
//-------------------------------------------------------------------------------------------------------------------
	...
	{
		if( !myQueue.isFull() )
			myQueue.insert(custN);	//put customer # in queue
	//start our timer
	}
//---------------------------------------------------------------------------------------------------------------
	public void tick()
...
class Store
{
	private int maxCheckers;	//max # of checkers
	private int maxLength; 		//max # of customers per line
	private Checker[] checkers; 	//array of checkers
	private long elapsedTime;
//-----------------------------------------------------------------------------------------------------------------
	public Store(int maxCh, int maxL)	//constuctor
	{
		maxCheckers = maxCh;
		maxLength = maxL;
		elapsedTime = 0;
...
class SimApp
{
	...
	{
		int nCheckers = 4;	//number of checkers
		int maxLL = 12;	//max line length
